 ...
 */
class CRM_Membershipextrasimporterapi_Upgrader_Base {

  /**
   * @var CRM_Membershipextrasimporterapi_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Membershipextrasimporterapi_Upgrader(
        'uk.co.compucorp.membershipextrasimporterapi',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Membershipextrasimporterapi_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Membershipextrasimporterapi_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
